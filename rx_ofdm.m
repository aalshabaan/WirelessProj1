...
[data_idx, ~] = frame_sync(filtered_rx,preamble,conf.os_factor_sc);%We get the peak phase

% Uncomment for relative cyclic prefix length
% len_symbol = floor(conf.N*conf.os_factor_ofdm*(1+conf.ncp));

% Uncomment for absolute relative prefix length
